"""
Django settings for Pokemon_Shop project.
...
SECRET_KEY = 'django-insecure-x+_vv0&riou#k_6!9i3+(y5myh=%9(pz)3b!tg-^+@w1k188hq'
...
ROOT_URLCONF = 'Pokemon_Shop.urls'
...
WSGI_APPLICATION = 'Pokemon_Shop.wsgi.application'
